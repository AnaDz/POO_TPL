...
public class ChefRobotEvolue {
    ...
    /**
     * Le tableau d'assignement des incendies incendieAssignes[i] = true si le
     * ième incendie est assigné
     */
    ...
    public ChefRobotEvolue(DonneesSimulation data, GestionnaireEvents GE) throws CloneNotSupportedException {
        this.data = data;
        this.GE = GE;
        initialise();
    }

    private void initialise() throws CloneNotSupportedException {
    ...
    /**
     * Programme la liste des déplacements élémentaires pour qu'un robot se
     * déplace suivant un chemin
     *
     * @param rob	le robot à déplacer
     * @param chemin	le chemin à suivre
     * @param couts	le couts du chemin = les dates auxquelles le robot arrive
     * sur les cases
     * @param date_debut	la date à laquelle le robot commence à se déplacer
     * @return	la date à laquelle le robot est arrivé sur la dernière case du
     * chemin
     */
