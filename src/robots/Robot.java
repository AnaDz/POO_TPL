...
public abstract class Robot {
     ...
     */
    /**
     * Construit une instance de la classe Robot en conservant la vitesse par
     * défaut
     *
    ...
    /**
     * Construit une instance de la classe Robot en modifiant la vitesse par
     * défaut.
     *
    ...
    /**
     * Retourne la direction vers laquelle se déplace le robot. Null si ne se
     * déplace pas.
     *
    ...
    /**
     * Retourne le nombre d'itérations nécessaires au robot pour se déplace à la
     * case c
     *
    ...
    /**
     * Calcule le nombre d'itérations nécessaires au robot pour verser un volume
     * vol de son réservoir.
     *
     * @param h	le temps (en minutes) alloué au robot entre chaque itération
    ...
    /**
     * Augmente la quantité d'eau présente dans le reservoir, sans vérifier que
    ...
    /**
     * Retourne true si le robot possède un volume suffisant pour pouvoir le
